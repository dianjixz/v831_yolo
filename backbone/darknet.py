    ...
    if pretrained:
        ...
        if hr:
            ...
            if torch.cuda.is_available():
                ...
                model.load_state_dict(torch.load(path_to_dir + '/weights/darknet_tiny_hr_61.85.pth', map_location='cpu'), strict=False)
        else:
            ...
            if torch.cuda.is_available():
                ...
                model.load_state_dict(torch.load(path_to_dir + '/weights/darknet_tiny_63.50_85.06.pth', map_location='cpu'), strict=False)
    return model
